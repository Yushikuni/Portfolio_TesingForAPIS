...
function Resume() {
    ...
    useEffect(() => {
        fetch('/utils/resumeData.json') // Ověř správnou cestu
            .then((response) => response.json())
            .then((data) => {
                setResumeData(data);
            })
            .catch((error) => console.error('Error loading resumeData:', error));
    }, []);
    ...
    return (
        <div className='main_resume_div'>
            ...
            {/* Resume - Work Experience, Education, Certificates */}
            <Grid container className="section pb_45">
                <Grid item className="section_title mb_30">
                    <span></span>
                    ...
                    <Grid container className="resume_timeline">
                        ...
                        <Grid item sm={12} md={4}>
                            <CustomTimeline title='Work experience' icon={<WorkIcon />}>
                                {resumeData.expiriences?.map((expirience, index) => (
